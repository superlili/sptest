...
<form class="layui-form" action="/Sctask/selectTasks" method="post">
    <#--<div class="btn-group">-->
        ...
        <#--<ul class="dropdown-menu" role="menu">-->
            <#--<li><a href="/Sctask/selectTasks">全部的空间众包任务</a></li>-->
            <#--<li class="divider"></li>-->
    ...
    <table class="table table-bordered table-striped table-hover">
        ...
        <tr>
            ...
            <td><a href="/Sctask/getTask?id=${userInfo.sc_push_pusher_id}&theme=${userInfo.sc_push_theme}">点击查看</a></td>
